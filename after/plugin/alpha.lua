...
local function button(sc, txt, keybind, keybind_opts)
    ...
    local function on_press()
        ...
        local key = vim.api.nvim_replace_termcodes(sc_ .. "<Ignore>", true,
                                                   false, true)
...
local version = {
    type = "text",
    val = "NVIM " .. vim_ver.major .. "." .. vim_ver.minor .. "." ..
        vim_ver.patch,
...
alpha.setup({
    layout = {
        {type = "padding", val = 4}, section.header,
        {type = "padding", val = 4}, section.buttons,
        {type = "padding", val = 2}, section.greeting,
        {type = "padding", val = 1}, section.datetime,
        {type = "padding", val = 2}, section.signature,
        {type = "padding", val = 1}, section.version
    },
    opts = {margin = 6}
})
